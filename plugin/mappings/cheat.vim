...
nnoremap <silent> <leader>Cc <cmd>call cheat#cheat("", getcurpos()[1], getcurpos()[1], 0, 0, '!')<CR>.
let g:which_key_map.C.c = 'search current line on cheat.sh (opens new window)'

nnoremap <silent> <leader>Cr <cmd>call cheat#cheat("", getcurpos()[1], getcurpos()[1], 0, 1, '!')<CR>
let g:which_key_map.C.r = 'search current line on cheat.sh (replace current line)'

nnoremap <silent> <leader>Ce <cmd>call cheat#cheat("", -1, -1 , -1, 5, '!')<CR>
let g:which_key_map.C.e = 'search first error on cheat.sh (opens new window)'

nnoremap <silent> <leader>CC <cmd>call cheat#navigate(0, 'C')<CR>
