...
local named_function_node = format(
  '<keyword><name>(<parameter>)<return_type> {\n  <body>\n}',
  {
...
local asynchronous_anonymous_function_node = format(
  '<keyword><parameter>) =>> { <body> }',
  {
...
local function get_case_node(index)
  return dynamic_node(
    index,
    function()
      return snippet_node(nil, format(
        '<keyword><condition>:\n  <body>\n  break;\n<continuation>',
        {
