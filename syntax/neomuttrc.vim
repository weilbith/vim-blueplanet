...
" Note:		Copied from /usr/share/nvim/runtime/syntax/neomuttrc.vim
"		Adjustments for function overwriting and missing keywords.
...
call s:boolQuadGen('Bool', [
			...
			\ 'sidebar_visible', 'sidebar_component_depth', 'sig_dashes', 'sig_on_top', 'smart_wrap',
...
call s:boolQuadGen('Quad', [
			\ 'abort_noattach', 'abort_noattach_regex', 'abort_nosubject', 'abort_unmodified', 'bounce',
