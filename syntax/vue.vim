" Vim syntax file
" Language: Vue.js
" Acknowledgement: https://github.com/posva/vim-vue
...
function! s:register_language(language, tag, ...)
  let l:attr_override = a:0 ? a:1 : ''
  let l:attr = !empty(l:attr_override) ? l:attr_override : s:attr('lang', a:language)
...
if !exists('g:vue_disable_pre_processors') || !g:vue_disable_pre_processors
  " Comment a bunch out, cause I don't use them so far and it just make it
